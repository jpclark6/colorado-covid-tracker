...
# sql = "CREATE TABLE vaccines (reporting_date date PRIMARY KEY, positive integer, hospitalized_currently integer, death_confirmed integer, positive_increase integer, death_increase integer, hospitalized_increase integer);"
# cur.execute(sql)
